 ...
 * 
 */
@WebServiceClient(name = "TrainService", targetNamespace = "http://mohamed.nl/treinservice/", wsdlLocation = "file:/E:/IAC/TreinEnergyService/src/main/java/service/TrainService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName TRAINSERVICE_QNAME = new QName("http://mohamed.nl/treinservice/", "TrainService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/E:/IAC/TreinEnergyService/src/main/java/service/TrainService.wsdl");
     ...
     * 
     * @return
     *     returns TrainPortType
     */
    @WebEndpoint(name = "TrainServicePort")
    public TrainPortType getTrainServicePort() {
        return super.getPort(new QName("http://mohamed.nl/treinservice/", "TrainServicePort"), TrainPortType.class);
    }
     ...
     */
    @WebEndpoint(name = "TrainServicePort")
    public TrainPortType getTrainServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://mohamed.nl/treinservice/", "TrainServicePort"), TrainPortType.class, features);
    }
